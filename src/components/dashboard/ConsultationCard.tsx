...
export const ConsultationCard: React.FC = () => {
  ...
  return (
    <div className="card-elevated p-4 sm:p-6 md:p-8 bg-gradient-to-br from-card via-card to-secondary/20 relative overflow-hidden border border-white/5 shadow-2xl min-w-0">
      {/* Decorative Glow */}
